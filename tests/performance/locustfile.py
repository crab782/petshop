...
class UserLoginUser(HttpUser):
    ...
    def login(self):
        ...
        with self.client.post("/api/auth/login", json=payload, catch_response=True, name="[User] Login") as response:
...
class MerchantLoginUser(HttpUser):
    ...
    def merchant_login(self):
        ...
        with self.client.post(
            "/api/auth/merchant/login", json=payload, catch_response=True, name="[Merchant] Login"
        ) as response:
            if response.status_code == 200:
                data = response.json()
                if data.get("code") == 200:
...
class CreateAppointmentUser(HttpUser):
    ...
    def login(self):
        ...
        response = self.client.post("/api/auth/login", json=payload, name="[CreateAppointment] Login")
...
class CreateProductOrderUser(HttpUser):
    ...
    def login(self):
        ...
        response = self.client.post("/api/auth/login", json=payload, name="[CreateProductOrder] Login")
    ...
    def create_order(self):
        ...
        payload = {
            "items": [{"productId": self.test_data["product_id"], "quantity": random.randint(1, 3)}],
            "addressId": 1,
        ...
        with self.client.post(
            "/api/user/orders", json=payload, headers=headers, catch_response=True, name="[User] Create Product Order"
        ) as response:
            if response.status_code in [200, 201]:
                data = response.json()
...
class QueryAppointmentsUser(HttpUser):
    ...
    def login(self):
        ...
        response = self.client.post("/api/auth/login", json=payload, name="[QueryAppointments] Login")
    ...
    def query_appointments(self):
        ...
        params = {"page": random.randint(0, 5), "pageSize": random.choice([10, 20, 50])}
...
class QueryProductOrdersUser(HttpUser):
    ...
    def login(self):
        ...
        response = self.client.post("/api/auth/login", json=payload, name="[QueryProductOrders] Login")
    ...
    def query_orders(self):
        ...
        params = {"page": random.randint(1, 5), "pageSize": random.choice([10, 20, 50])}

        with self.client.get(
            "/api/user/orders", params=params, headers=headers, catch_response=True, name="[User] Query Product Orders"
        ) as response:
            if response.status_code == 200:
                data = response.json()
                if data.get("code") == 200:
...
class MixedScenarioUser(HttpUser):
    ...
    def login(self):
        ...
        response = self.client.post("/api/auth/login", json=payload, name="[Mixed] Login")
    ...
    def re_login(self):
        ...
        with self.client.post("/api/auth/login", json=payload, catch_response=True, name="[Mixed] Login") as response:
            if response.status_code == 200:
                data = response.json()
                if data.get("code") == 200 and data.get("data"):
                    self.token = data["data"].get("token")
    ...
    def query_appointments(self):
        ...
        params = {"page": random.randint(0, 3), "pageSize": 10}
    ...
    def query_orders(self):
        ...
        params = {"page": random.randint(1, 3), "pageSize": 10}

        with self.client.get(
            "/api/user/orders", params=params, headers=headers, catch_response=True, name="[Mixed] Query Orders"
        ) as response:
            if response.status_code == 200:
                data = response.json()
                if data.get("code") == 200:
    ...
    def create_order(self):
        ...
        payload = {
            "items": [{"productId": self.test_data["product_id"], "quantity": random.randint(1, 2)}],
            "addressId": 1,
            "remark": f"Mixed scenario test - {generate_random_string()}",
        }
        ...
        with self.client.post(
            "/api/user/orders", json=payload, headers=headers, catch_response=True, name="[Mixed] Create Order"
        ) as response:
            if response.status_code in [200, 201]:
                data = response.json()
                if data.get("orderId") or data.get("success"):
    ...
    def get_profile(self):
        ...
        with self.client.get(
            "/api/user/profile", headers=headers, catch_response=True, name="[Mixed] Get Profile"
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
