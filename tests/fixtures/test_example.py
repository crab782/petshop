...
from tests.fixtures import TestData, TestDataGenerator, setup_test_environment, teardown_test_environment
...
class TestWithExistingData:
    ...
    def test_use_existing_merchant(self, http_client: HTTPClient):
        ...
        response = http_client.get("/api/merchant/profile", user_type="merchant")
