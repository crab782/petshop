...
- **Files modified**:
  - `src/main/java/com/petshop/controller/api/PublicApiController.java`
...
- **Files created/modified**:
  ...
  - `src/main/java/com/petshop/controller/api/ProductApiController.java`
...
- **Files modified**:
  ...
  - `src/main/java/com/petshop/entity/ProductOrder.java`
  - `src/main/java/com/petshop/repository/ProductOrderRepository.java`
...
- **Files created/modified**:
  ...
  - `src/main/java/com/petshop/controller/api/SearchApiController.java`
...
- **Files created/modified**:
  ...
  - `src/main/java/com/petshop/controller/api/AnnouncementApiController.java`
...
- **Files created/modified**:
  ...
  - `src/main/java/com/petshop/dto/HomeStatsDTO.java`
  - `src/main/java/com/petshop/dto/ActivityDTO.java`
...
- **Files modified**:
  - `src/main/java/com/petshop/service/FavoriteService.java`
  - `src/main/java/com/petshop/entity/Favorite.java`
  - `src/main/java/com/petshop/repository/FavoriteRepository.java`
...
- **Files created/modified**:
  - `src/main/java/com/petshop/dto/UserPurchasedServiceDTO.java`
...
- **Status**: COMPLETED
- **Description**:
  - Backend compiles successfully (mvn compile -DskipTests)
  - All 85 API endpoints implemented
...
All 18 tasks have been completed successfully. The backend now implements **85 REST API endpoints** that precisely match the 28 user-side frontend pages.
